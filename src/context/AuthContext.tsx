...
interface AuthContextType extends AuthState {
    ...
    register: (data: { name: string; email: string; password: string; phone?: string; role?: 'CLIENTE' | 'PROVEEDOR' }) => Promise<void>;
    /** Cierra sesión */
    logout: () => Promise<void>;
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
     ...
     * Registra un nuevo usuario (cliente o proveedor)
     */
    const register = useCallback(async (data: { name: string; email: string; password: string; phone?: string; role?: 'CLIENTE' | 'PROVEEDOR' }) => {
        setState(prev => ({ ...prev, isLoading: true, error: null }));
